...
export interface EquipmentModifierContainerData extends Omit<EquipmentModifierContainerSource, "effects" | "flags" | "items">, EquipmentModifierContainerSystemData {

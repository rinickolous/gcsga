...
export function processMultiplyAddWeightStep(type: EquipmentWeightType, weight: number, _units: WeightUnits, modifiers: Collection<EquipmentModifierGURPS>): number {
	let sum = 0;
	for (const mod of modifiers) {

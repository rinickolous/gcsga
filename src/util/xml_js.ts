export function XMLtoJS(xml: string) {
	...
	// const xmlDoc = parseXml(xml, ["count"]);
	// console.log(xmlDoc);
	// return parseXml(xml, ["count", "trait", "damagebreak", "modifiers"]);
	return parseXml(xml, [
		"damagebreaks",
		"modifier",
		"trait",
...
function parseXml(xml: string, arrayTags: string[]) {
	...
	function parseNode(xmlNode: any, result: any, parent = "") {
		if (xmlNode.nodeName == "portraitimage")
			console.log(xmlNode, xmlNode.childNodes);
	...
	<character>
		...
		<symbols count="10">
			<symbol>
				...
				<image>
					<![CDATA[iVBORw0KGgoAAAANSUhEUgAAAA8AAAAQCAYAAADJViUEAAAABGdBTUEAALGPC/xhBQAAAAlwSFlz
...
xg3BO+JKFy8frAAAAABJRU5ErkJggg==]]>
				</image>
			</symbol>
			<symbol>
...
xg3BO+JKFy8frAAAAABJRU5ErkJggg==]]>
			...
			<symbol>
				...
				<image>
					<![CDATA[iVBORw0KGgoAAAANSUhEUgAAABIAAAAQCAYAAAAbBi9cAAAABGdBTUEAALGOfPtRkwAAACBjSFJN
...
t5qafh4dHRVavm5W+AcdOU+oJg4HaAAAAABJRU5ErkJggg==]]>
				</image>
			</symbol>
			<symbol>
...
t5qafh4dHRVavm5W+AcdOU+oJg4HaAAAAABJRU5ErkJggg==]]>
			...
			<symbol>
				...
				<image>
					<![CDATA[
...
YII=]]>
			...
			<symbol>
				...
				<image>
					<![CDATA[
...
940bNqSDxL8BnQlS+Pv3bwYAMpFXIhl5lWQAAAAASUVORK5CYII=]]>
				</image>
			</symbol>
			<symbol>
...
940bNqSDxL8BnQlS+Pv3bwYAMpFXIhl5lWQAAAAASUVORK5CYII=]]>
			...
			<symbol>
				...
				<image>
					<![CDATA[
...
wWAgl0hkDF38A21mvYCD3yJiwaI6kUNAAAAAAElFTkSuQmCC]]>
				</image>
			</symbol>
			<symbol>

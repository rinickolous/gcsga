...
const GURPSCONFIG: any = {
	...
	select: {
		...
		string_compare: {
			none: "gcsga.select.string.compare.none",
			is: "gcsga.select.string.compare.is",
			is_not: "gcsga.select.string.compare.is_not",
			contains: "gcsga.select.string.compare.contains",
			does_not_contain: "gcsga.select.string.compare.does_not_contain",
			starts_with: "gcsga.select.string.compare.starts_with",
			does_not_start_with: "gcsga.select.string.compare.does_not_start_with",
			ends_with: "gcsga.select.string.compare.ends_with",
			does_not_end_with: "gcsga.select.string.compare.does_not_end_with",
		},
		has: {
